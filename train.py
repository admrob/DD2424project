...
def get_data(num_samples=1000, data_path = '', data_type = 'text'):
...
def main(params):
    ...
    timesteps_max, enc_tokens, characters, char2id, id2char, x, x_decoder = get_data(num_samples=num_samples,
                                                                                          data_path=data_path,
                                                                                          data_type = data_type)
